...
* @Last Modified time: 2017-12-14 11:57:01
*/
	...
	*/
	...
	function $(select,ranger = document){
		if(typeof select == 'string'){
			// ranger = ranger ？ranger:document;     三元运算符
			...
			}else if(/^[a-zA-Z][A-Za-z1-6]{0,10}$/.test(selector)){     /*判断是否是标签用正则判断一下*/
